...
<script src="//code.jquery.com/jquery-1.10.2.js"></script>
 <script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
  <title>Crear papeleta individual</title>
...
<body>
<h1>Crear Papeleta Individual</h1>
<div class="contenedor-formulario">
  <div class="wrap">
    <form method="POST" action="crear_papeletas.php" class="formulario" name="formulario_registro" >  
    ...
    <div id="display">
     ...
     <label class="label" for="cantidad"></label> 
      ...
      <div class="input-group">
     <input type="text" placeholder="Lote 1:" id="lote1" name="lote1">
     <label class="label" for="lote1"></label> 
     </div>

     <div class="input-group">
     <input type="text" placeholder="Lote 2:" id="lote2" name="lote2">
     <label class="label" for="lote2"></label> 
     </div>
   ...
   <div class="input-group">
    <input type="text" placeholder="Tarimas:" id="tarimas" name="tarimas">
    <label class="label" for="tarimas"></label>
    </div>
